...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), description: " This is a very long description used to test out if my stuff is displayed", inventory: 1)
end
5.times do
